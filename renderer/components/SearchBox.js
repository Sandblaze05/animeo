      ...
      >
        <div className='flex items-center justify-center w-full h-13 px-2 shrink-0'>
          ...
          <input
            ...
            autoFocus
            className='w-[95%] ring-0 outline-0 px-4 pt-2 pb-4 bg-transparent border-none focus:outline-none'
          />
        </div>
                ...
                >
                  <div className='flex flex-col justify-center items-start gap-1 max-w-[80%]'>
                    ...
                    <span className='text-xs flex items-center gap-1'>
                      <p>{anime.aired?.string?.split('to')[0].trim() || 'N/A'}</p>
                      •
                      <p>{anime.type}</p>
                      •
                  ...
                  <div className='h-14 w-10 bg-white/20 overflow-clip rounded-sm'>
                    <img alt='' src={anime.images.webp.small_image_url} className='object-cover w-full h-full' />
                  </div>
                </motion.div>
              ))}
            </AnimatePresence>
