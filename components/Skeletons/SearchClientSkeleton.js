  ...
  return (
    <div className='mt-20 border-t-1 border-white/20 w-screen flex flex-col text-white'>
      ...
      <div className='w-screen flex'>
        <div className='relative flex flex-col items-center justify-start w-screen lg:w-[70%] h-screen rounded-none border-r-0 lg:rounded-tr-xl border-t-1 lg:border-r-1 border-white/20'>
